...
<link rel="stylesheet" href="{{ asset('vizabi_resource/linechart.css') }}" />
...
<script src="{{ asset('vizabi_resource/systema-globalis/ConfigLineChart.js') }}"></script>
<script src="{{ asset('vizabi_resource/linechart.js') }}"></script>
<script
...
<script>
    ...
    try {
        ...
        Vizabi("LineChart", document.getElementById("placeholder"), config);
    }
    catch(err) {
        alert(err.message);
    }
