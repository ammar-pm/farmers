<h2 class="text-uppercase">{{ __('common.plotly_options') }}</h2>
...
<div class="form-row">
  <div class="form-group col">
    ...
    <label for="xaxis">{{ __('common.x_axis') }} <sup>*</sup></label>
  </div>

  <div class="form-group col" v-if="form.options.type == 'bubble'">
  ...
  <div class="form-group col" v-if="form.options.type == 'bubble'">
    ...
    <label for="zaxis">{{ __('common.z_axis') }} <sup>*</sup></label>
  </div>

  <!-- <div class="form-group col">
    <input type="text" class="form-control" v-model="form.options.plotly_title">
    <label> __('common.sub_title') }} </label>
  </div> -->

  <div class="form-group col">
    <input type="text" class="form-control" v-model="form.options.plotly_scale">
...
<div class="form-row">
  <div             id="baseselector"
                   name="baseselector" class="form-group col">
    <agg-tree-select
    ...
    ></agg-tree-select>
    <label> {{ __('common.base_selector') }} <sup>*</sup></label>
  </div>
